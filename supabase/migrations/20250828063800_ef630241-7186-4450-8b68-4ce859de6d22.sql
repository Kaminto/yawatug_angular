...
CREATE TABLE IF NOT EXISTS public.email_providers (
  ...
  cost_per_email NUMERIC DEFAULT 0.0001,
...
CREATE POLICY "Admin can manage email providers" ON public.email_providers FOR ALL USING (get_current_user_role() = 'admin');
...
CREATE INDEX IF NOT EXISTS idx_email_providers_active ON public.email_providers(is_active, priority);
...
INSERT INTO public.email_providers (provider_name, provider_type, configuration, cost_per_email, priority, is_active)
