...
('OTP Verification', 'otp', 'otp_verification', 'YAWATU OTP: Your verification code is {{otp_code}}. Valid for {{expiry_minutes}} minutes. Do not share this code.', '["otp_code", "expiry_minutes"]'::jsonb, true, 'en'),
('Welcome Message', 'notification', 'welcome', 'YAWATU: Welcome to our platform! Your account has been activated successfully.', '[]'::jsonb, true, 'en'),
('Password Reset', 'otp', 'password_reset', 'YAWATU: Your password reset code is {{reset_code}}. Valid for 15 minutes.', '["reset_code"]'::jsonb, true, 'en'),
('Transaction Alert', 'notification', 'transaction_alert', 'YAWATU: Transaction alert - {{transaction_type}} of {{amount}} {{currency}} completed successfully.', '["transaction_type", "amount", "currency"]'::jsonb, true, 'en');
