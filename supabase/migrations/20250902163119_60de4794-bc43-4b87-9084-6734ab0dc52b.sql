...
-- First, let's see what codes are currently in use and fix conflicts
...
-- Step 5: Create trigger to automatically handle future referrals
-- First, create a function to process referral signup
...
BEGIN
  ...
  SELECT id, full_name INTO referrer_id, referrer_record
  FROM public.profiles 
