...
BEGIN
  ...
  cron_command := 'SELECT net.http_post(url := ''https://lqmcokwbqnjuufcvodos.supabase.co/functions/v1/trigger-auto-pricing'', headers := ''{"Content-Type": "application/json", "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxxbWNva3dicW5qdXVmY3ZvZG9zIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDcyNTA2ODksImV4cCI6MjA2MjgyNjY4OX0.NGjUtUJJaChBRTBsHMCV_20ZZNp1f9iB0RHRM65Dksw"}''::jsonb, body := ''{"automated": true}''::jsonb) as request_id;';

  -- Schedule the cron job
  PERFORM cron.schedule(job_name, cron_expression, cron_command);
