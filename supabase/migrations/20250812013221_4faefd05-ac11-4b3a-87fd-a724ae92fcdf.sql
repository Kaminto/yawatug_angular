-- Fix the profiles creation and club share allocation issues

-- First, let's create missing profiles for club members with correct activation status
...
SELECT 
  ...
  'pending',  -- Changed from activation_required to pending
