-- Update the check constraint to allow more promotion types
ALTER TABLE public.promotions DROP CONSTRAINT promotions_promotion_type_check;

ALTER TABLE public.promotions ADD CONSTRAINT promotions_promotion_type_check 
CHECK (promotion_type = ANY (ARRAY[
    'bonus_shares', 'discount', 'cashback', 'referral_bonus', 
    'bonus', 'exclusive_access', 'consultation', 'early_access'
]));

-- Insert sample promotions with allowed promotion types
