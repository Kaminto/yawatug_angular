-- Data Recovery Migration: Restore Lost Referral Earnings (Final Working Version)
...
BEGIN
    ...
    LOOP
        ...
        -- Insert recovered commission record using correct column names
    ...
    FROM referral_commissions rc
    WHERE rc.created_at >= CURRENT_DATE; -- Count today's recovered records
...
INSERT INTO referral_data_audit (
    ...
    jsonb_build_object(
        'migration_date', now(),
        'description', 'Successfully recovered referral earnings from transaction history',
        'tables_affected', ARRAY['referral_commissions', 'referral_statistics']
    )
);