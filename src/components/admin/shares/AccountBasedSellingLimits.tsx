...
import { TrendingDown, Edit } from 'lucide-react';
...
const AccountBasedSellingLimits: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const limitData = {
        ...
        weekly_limit: parseFloat(formData.weekly_limit),
  ...
  return (
    <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center">
              ...
              Edit Account-Based Selling Limits
            </CardTitle>
          </CardHeader>
        <CardContent>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, weekly_limit: e.target.value }))}
      ...
      <Card>
        <CardHeader>
          <CardTitle>Account-Based Selling Limits</CardTitle>
        </CardHeader>
        <CardContent>
          {limits.length === 0 ? (
                  ...
                  <div className="flex justify-between items-start">
                    <div className="space-y-2">
                      <div className="font-semibold capitalize">
                        {limit.account_type} - {limit.limit_type}
                      </div>
                      <div className="text-sm text-muted-foreground space-y-1">
                        <div>Daily: {limit.daily_limit.toLocaleString()}{limit.limit_type === 'quantity' ? ' shares' : '%'}</div>
                        <div>Weekly: {limit.weekly_limit.toLocaleString()}{limit.limit_type === 'quantity' ? ' shares' : '%'}</div>
                        <div>Monthly: {limit.monthly_limit.toLocaleString()}{limit.limit_type === 'quantity' ? ' shares' : '%'}</div>
                      </div>
...
export default AccountBasedSellingLimits;