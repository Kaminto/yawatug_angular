-- Fix booking payment fee handling to stop referencing transaction_fee_collections
-- Update process_booking_payment to use allocate_transaction_fee_with_snapshot and rely on transactions table fee columns
