-- Fix the submit_sell_order function to prevent infinite recursion
...
BEGIN
  ...
  -- Check user holdings (direct shares only)
  ...
  IF v_user_holdings < p_quantity THEN
    RAISE EXCEPTION 'Insufficient shares. You have % direct shares available', v_user_holdings;
  END IF;
