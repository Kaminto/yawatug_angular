...
BEGIN
  ...
  SELECT public.get_current_share_price((SELECT id FROM public.shares LIMIT 1), 'buy') INTO current_share_price;
  
  -- Check if fee is paid
  SELECT EXISTS (
    SELECT 1 FROM public.debt_conversion_fee_payments
